def make_parser(subparsers):
    ...
    add("-f", "--force", action="store_true", help="force pull if image already exists")
    ...
    add("-p", "--podman", action="store_true", help="Pull base images using podman.")

    add("-cb", "--cab-base", nargs="+", help="Pull base image for specified cab")
