def make_parser(subparsers):
    ...
    parser.add_argument("-l", "--list", action="store_true", help="List cab names")
...
to get help on the 'cleanmask cab' run 'stimela cabs --cab-doc cleanmask'",
    ...
    parser.add_argument("-ls", "--list-summary", action="store_true", help="List cabs with a summary of the cab")
