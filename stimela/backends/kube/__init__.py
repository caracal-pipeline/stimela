...
resource_labels = dict(stimela_user=session_user, stimela_session_id=session_id)
...
InjectedFileFormatters = dict(yaml=yaml.dump, json=json.dumps, txt=str)
...
class KubeBackendOptions(object):
    ...
    class DebugOptions(object):
        ...
        save_spec: Optional[str] = (
            None  # if set, pod/job specs will be saved as YaML to the named file. {}-substitutions apply to filename.
        )
        ...
        event_colors: Dict[str, str] = DictDefault(warning="blue", error="yellow", default="grey50")
