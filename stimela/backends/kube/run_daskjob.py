...
def find_daskjob_components(daskjob, namespace):
    ...
    runner_pod = v1.list_namespaced_pod(
        namespace=namespace, label_selector=f"dask.org/cluster-name={job_name},dask.org/component=job-runner"
    )
...
def daskjob_factory(job_name="sjp", image="ghcr.io/dask/dask", namespace="rarg-test-compute"):
    ...
    try:
        api_response = api_instance.list_namespaced_custom_object(
            DASKJOB_GROUP, DASKJOB_VERSION, namespace, DASKJOB_PLURAL
        )
